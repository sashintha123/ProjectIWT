...
<body>
    ...
    <div class="ebookPdfButtonSet">
        <a href="ebookPdfResult.php?resourceType=ebook"><button class="ebookPdfButtons">E-Book</button></a>
        <a href="ebookPdfResult.php?resourceType=pdf"><button class="ebookPdfButtons">PDF</button></a>
    </div>
