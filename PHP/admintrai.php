...
<body>
  <section id="menu">
    ...
    <div class="items">
      ...
      <li><a href="#">Registered Trainees</a></li>
      ...
      <table width="100%">
        ...
        <tbody>
             ...
             <?php
                 ...
                 $sql = "SELECT id,fname,lname,email,mobile,subject FROM trainee ORDER BY id DESC";
                 ...
                 if($result -> num_rows>0)
                 {
                   while($row = $result -> fetch_assoc())
                   {
                     ...
                     echo "<td>  <a href = 'deletet.inc.php?id={$row['id']}'>Delete</a></td>";
                     echo "</tr>";
                   }
                 }
